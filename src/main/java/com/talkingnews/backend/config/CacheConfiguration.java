package com.talkingnews.backend.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.talkingnews.backend.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.talkingnews.backend.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
